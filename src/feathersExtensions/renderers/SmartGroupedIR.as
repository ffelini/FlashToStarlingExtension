...
public class SmartGroupedIR extends DefaultGroupedListItemRenderer
	{
		public function SmartGroupedIR()
		{
			super();
		...
		{
			return layoutData as SmartAnchorLayoutData || (owner is SmartGroupedList ? (owner as SmartGroupedList).smartItemLayoutData : null);
		}
		protected var selectionSizeFactor:Number = 1;
		...
		override protected function accessory_touchHandler(event:TouchEvent):void
		{
			...
			if(owner && owner is SmartGroupedList) (owner as SmartGroupedList).disableAppDrawers(accessoryTouchPointID>=0,true);
		}
