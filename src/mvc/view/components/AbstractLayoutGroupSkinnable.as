...
public class AbstractLayoutGroupSkinnable extends SmartLayoutGroupSkinnable implements IAbstractView
	{
		public function AbstractLayoutGroupSkinnable(_initChildren:Boolean=false)
		{
			super(_initChildren);
		}
