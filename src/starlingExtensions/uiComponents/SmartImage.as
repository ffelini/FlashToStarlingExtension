...
public class SmartImage extends Image implements IClonable, ISmartImage, IOptimizedDisplayObject
	{
		private static var _defaultTexture:Texture;
		public static function get defaultTexture():Texture {
			if(!_defaultTexture) {
				_defaultTexture = Texture.fromColor(2,2);
			}
			return _defaultTexture;
		}
		
		public function SmartImage(texture:Texture)
		{
		...
		{
			var c:SmartImage = new SmartImage(texture);
			return c;
		}
	}
}