...
/** A utility class containing methods related to the Rectangle class. */
    public class RectangleUtil
    {
        ...
        /** @private */
        public function RectangleUtil() { throw new Error("you should not call the constructor for this class"); }
		...
		[Inline]
		public static function scaleToContent(obj:*,_coordinateSystemRect:Rectangle,centrateAllToContent:Boolean,scale:Number=1,maxRect:Rectangle=null):void
		{
			helpRect = obj.hasOwnProperty("getRect") ? obj.getRect(obj.parent) : obj.getBounds(obj.parent,helpRect);
			validateRect(helpRect);
			
			var raport:Number = helpRect.width/helpRect.height;
			...
			if(obj is IOptimizedDisplayObject) (obj as IOptimizedDisplayObject).setSize(helpRect.width,helpRect.height);
			else
			{
			...
			if(maxRect && (helpRect.width>maxRect.width || helpRect.height>maxRect.height))
			{
		...
		public static function centrateToStage(obj:Object,coordinateSystemRect:Rectangle,xOffset:Number=1,yOffset:Number=1):void
		{
